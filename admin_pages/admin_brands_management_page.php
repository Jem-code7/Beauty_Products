...
<body>
      <?php include_once '../section_template/admin_header.php'?>
            ...
            <section class="main-content grad-pink-cream" style="padding-bottom: 10%;">
                  <div class="mx-5">
                        <h1><strong>Manage Brands</strong></h1>

                        <br><br>
                        <a href=""><button class="btn btn-warning">Add Brands</button></a>
                        <br><br><br>
                        <table style="width: 100%;">
                              ...
                              <?php                             
                              if ($res=mysqli_query($db->con, "SELECT * FROM tbl_brands WHERE active=1")) :
                                    if (mysqli_num_rows($res)>0) {
                                          ...
                                          while ($rows=mysqli_fetch_assoc($res)) :
                                                ...
                                                <tr>
                                                      <td><?php echo ($i+1)?> </td>
                                                      <td><img src="<?php echo $rows['image'] ?? "./img/Placeholders/No_Image_Placeholderpng.png"?>" alt="" style="width:50px; height:50px"></td>
                        ...
                        <table style="width: 100%;">
                              ...
                              <?php                             
                              if ($res=mysqli_query($db->con, "SELECT * FROM tbl_brands WHERE active=0")) :
                                    if (mysqli_num_rows($res)>0) {
                                          $i = 1;
                                          while ($rows=mysqli_fetch_assoc($res)) :
                                                ?>
                                                <tr>
                                                      ...
                                                      <td>
                                                            <a href="" class="btn btn-secondary">Update</a>
                                                            <a href="" class="btn btn-success">Reactivate</a>
                                                      </td>
                                                </tr>
                                                <?php
                                                $i++;
