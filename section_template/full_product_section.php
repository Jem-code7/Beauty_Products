      ...
      <div class="container py-5">
            ...
            <div class="grid">
                  <?php for ($i=0; $i < 10; $i++) : ?>
                        ...
                        <a href="">
                              <div class="grid-item frame p-2 text-center rounded Lotion">
                                    <div class="item p-2">
                                          <div class="products">
                        ...
                        <a href="">
                              <div class="grid-item frame p-2 text-center rounded Shampoo">
                                    <div class="item p-2">
                                          <div class="products">
                        ...
                        <a href="">
                              <div class="grid-item frame p-2 text-center rounded Facial Cream">
                                    <div class="item p-2">
                                          <div class="products">
